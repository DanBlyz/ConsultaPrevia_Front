...
@Component({
  selector: 'app-plantilla-linea',
  templateUrl: './linea.component.html',
  styles: []
})
export class LineaComponent implements BloqueComponente, OnInit {
  ...
  constructor(private fb: FormBuilder, private modalService: NgbModal) {
    ...
    this.formConfiguracion = this.fb.group({
      margenSuperior: [this.configuracion.margenSuperior, Validators.required],
      margenInferior: [this.configuracion.margenInferior, Validators.required]
    });
  }
  ...
  obtenerBloque(): Bloque {
    return {
      componente: LineaComponent.name,
      plantilla: 'linea',
      uid: this.uid,
