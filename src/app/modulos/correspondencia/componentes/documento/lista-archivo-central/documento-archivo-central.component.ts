...
@Component({
  selector: 'app-correspondencia-documento-archivo-central',
  templateUrl: './documento-archivo-central.component.html',
  styles: []
})
export class DocumentoArchivoCentralComponent
    ...
    this.suscripcion.add(
      this.documentoFacade.Filtro$.subscribe((filtro) => {
        if (filtro && this.paginador) {
          this.filtro = filtro;
          this.documentoFacade.archivoCentral(
            this.filtro,
            1,
