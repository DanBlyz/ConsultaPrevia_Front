...
@Component({
  selector: 'app-correspondencia-documento-archivo-central-detalle',
  templateUrl: './documento-archivo-central-detalle.component.html',
  styles: []
})
export class DocumentoArchivoCentralDetalleComponent
