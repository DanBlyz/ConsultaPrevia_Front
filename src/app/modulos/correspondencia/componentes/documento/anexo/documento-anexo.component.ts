...
@Component({
  selector: 'app-correspondencia-documento-anexo',
  templateUrl: './documento-anexo.component.html',
  styles: []
})
export class DocumentoAnexoComponent implements OnInit, OnDestroy {
        ...
        this.documentoFacade
          ...
          .then((respuesta) => {
            if (respuesta.tipoRespuesta === 'Exito') {
              this.accion.emit({
                accion: 'recargar-y-guardar-contenido'
              });
            }
          });
        break;
