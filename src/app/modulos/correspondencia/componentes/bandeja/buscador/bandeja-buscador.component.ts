...
import { DocumentoFilter, SeguimientoFilter } from '../../../modelos/filtros';

@Component({
  selector: 'app-correspondencia-bandeja-buscador',
  templateUrl: './bandeja-buscador.component.html',
  styles: []
})
export class BandejaBuscadorComponent implements OnInit {
  ...
  ejecutarAccion(): void {
    const objeto = { ...this.formBuscador.value } as SeguimientoFilter;
    this.accion.emit({
      accion: 'buscar',
      seguimiento: FuncionesHelper.quitarNulos(objeto)
    });
  }
