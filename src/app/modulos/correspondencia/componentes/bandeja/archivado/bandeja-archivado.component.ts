...
@Component({
  selector: 'app-correspondencia-bandeja-archivado',
  templateUrl: './bandeja-archivado.component.html',
  styles: []
})
export class BandejaArchivadoComponent
