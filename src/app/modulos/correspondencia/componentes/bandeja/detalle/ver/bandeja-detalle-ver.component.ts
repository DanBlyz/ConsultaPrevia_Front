...
@Component({
  selector: 'app-correspondencia-bandeja-detalle-ver',
  templateUrl: './bandeja-detalle-ver.component.html',
  styles: []
})
export class BandejaDetalleVerComponent implements OnInit, OnDestroy {
