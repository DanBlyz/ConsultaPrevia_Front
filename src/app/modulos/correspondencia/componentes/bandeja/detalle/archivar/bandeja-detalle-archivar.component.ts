...
@Component({
  selector: 'app-correspondencia-bandeja-detalle-archivar',
  templateUrl: './bandeja-detalle-archivar.component.html',
  styles: []
})
export class BandejaDetalleArchivarComponent implements OnInit, OnDestroy {
