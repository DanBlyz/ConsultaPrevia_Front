...
@Component({
  selector: 'app-correspondencia-bandeja-detalle-aprobar',
  templateUrl: './bandeja-detalle-aprobar.component.html',
  styles: []
})
export class BandejaDetalleAprobarComponent implements OnInit, OnDestroy {
